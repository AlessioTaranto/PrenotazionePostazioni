...
namespace prenotazioni_postazioni_api.Services
{
    public class PrenotazioneService
    {
       ...
       internal Prenotazione GetPrenotazioneById(int idPrenotazione)
        ...
        /// <summary>
        /// Query al db per restituire tutte le prenotazioni presenti nel database
        /// </summary>
        /// <returns>Lista di Prenotazione</returns>
       internal void save(PrenotazioneDto prenotazioneDto)
        {
            //save prenotazione da prenotazioneDto
        }
