...
namespace prenotazioni_postazioni_api.Repositories
{
    public class VotoRepository
    {
        ...
        {
            string query = $"INSERT INTO Voti (idUtente, idUtenteVotato, voto) VALUES ({voto.IdUtente.IdUtente}, {voto.IdUtenteVotato.IdUtente}, {voto.VotoEffettuato});";
            _databaseManager.CreateConnectionToDatabase(null, null, true);
        ...
        {
            string query = $"UPDATE Voti SET voto = 1 ^ voto WHERE idUtente = {voto.IdUtente.IdUtente} AND idUtenteVotato = {voto.IdUtenteVotato.IdUtente};";
            _databaseManager.CreateConnectionToDatabase(null, null, true);
            _databaseManager.GetNoneResult(query);
            _databaseManager.DeleteConnection();
        }
